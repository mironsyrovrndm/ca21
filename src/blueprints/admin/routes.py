...
def login_post():
    ...
    return render_template("admin/login.j2", error="Неверный логин или пароль")
...
def dashboard():
    ...
    return render_template("admin/dashboard.j2", stats=stats, upcoming=upcoming_preview)
...
def content():
    ...
    return render_template("admin/content.j2", uploads=uploads, content=content_data)
...
def clients():
    ...
    return render_template("admin/clients.j2", created=created, records=load_records())
